...
JSON_NAME_LOG = os.path.join(DATA_FOLDER, 'nome_arquivo.txt')
...
def nome_json():
    try:
        with open(JSON_NAME_LOG, 'r', encoding='utf-8') as f:
            return f.read()
    except:
        return "Desconhecido"
